 ...
 */
export type OptionalExcept<T extends Record<never, never>, K extends keyof T> = Pick<T, K> & Partial<Pick<T, K>>;
/**
 * Makes all properties of type `T` required except for those in `K`.
 */
export type RequiredExcept<T extends Record<never, never>, K extends keyof T> = Pick<T, Exclude<keyof T, K>> & Required<Pick<T, K>>;
/**
 ...
 */
export type MaybeAsync<T extends (...args: any[]) => any> = (...args: Parameters<T>) => Promise<ReturnType<T>> | ReturnType<T>;
/**
